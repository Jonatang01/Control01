...
class SellData {
	...
	public function gettipo(){return TipoVentaData::getById($this->tipo_id); }

	public function add(){
		$sql = "insert into ".self::$tablename." (invoice_code,comment,ref_id,person_id,stock_to_id,iva,p_id,d_id,tipo_id,total,discount,cash,user_id,created_at) ";
		$sql .= "value (\"$this->invoice_code\",\"$this->comment\",$this->ref_id,$this->person_id,$this->stock_to_id,$this->iva,$this->p_id,$this->d_id,$this->tipo_id,$this->total,$this->discount,$this->cash,$this->user_id,$this->created_at)";
		return Executor::doit($sql);
	}
	public function add_traspase(){
		$sql = "insert into ".self::$tablename." (tock_to_id,stock_from_id,operation_type_id,iva,p_id,d_id,total,discount,user_id,created_at) ";
